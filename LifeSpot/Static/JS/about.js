/**
 * Конструктор, через который создается комментарий
 * 
 * */
function Comment() {
    // Запросим имя
...
const writeReview = review => {
    ...
    if (review.hasOwnProperty('rate')) {
        ...
        // Для кнопки лайков добавляем: идентификатор, атрибут onclick для передачи идентификатора в функцию, 
        //значок лайка, и само значение счётчика отделяем пробелом
